  ...
  heal() {
    ...
    _this.id = setInterval(function() {
      ...
      if (i == 1) {
        ...
        _this.element.getElementsByClassName("heal-effect-image")[0].src = 'images/effect/heal/'+ i +'.png';
        console.log('images/effect/heal/'+ i +'.png');
        i++;
      //i>8 代表圖片撥放完畢
      if (i > 8) {
...
document.addEventListener('keydown', (event) => {
  ...
  if (keyName=="A"||keyName=="a"&&document.getElementsByClassName("skill-block")[0].style.display != "none"){
    heroAttack();
  }else if (keyName=="D"||keyName=="d"&&document.getElementsByClassName("skill-block")[0].style.display != "none"){
    heroHeal();
  }else if (keyName=="A"||keyName=="a"||keyName=="D"||keyName=="d"){
    alert("push too quick!");
  }else{
    alert("wrong key!");
  }
});
